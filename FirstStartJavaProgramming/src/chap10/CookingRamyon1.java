...
class RiceRamyon extends Ramyon
{
	...
	{
		boiled_pot=boilwater("전기 냄비", "물");
		System.out.println(boiled_pot+"에"+ramyon+"과"+vegetable+"와"+rice+"을 넣고"+
		time+"분간 끓인다(RiceRamyon클래스");
...
class CheeseRamyon extends Ramyon
{
	...
	{
		boiled_pot=boilwater("전기 냄비", "물");
		System.out.println(boiled_pot+"에"+ramyon+"과"+vegetable+"과"+cheese+
		"를 넣고 "+time+"분간 끓인다(CheeseRamyon클래스)");
...
public class CookingRamyon1 {
	...
	public static void main(String[] args) {
		...
		do
		{
			System.out.print("만들고 싶은 요리를 입력하세요(1:일반라면,2:떡라면,3:치즈라면,99종료) : ");
